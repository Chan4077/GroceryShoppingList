...
def cmd_delete_grocery_item():
    ...
    result = mbox.askokcancel(message="Are you sure you want to delete the grocery item?")
    print(result)
...
filemenu.add_command(label="New Grocery List...", underline=0, accelerator="Shift+Command+n",
...
filemenu.add_command(label="Delete Grocery Item...", underline=0,
                     accelerator="Option+Command+BackSpace", command=cmd_delete_grocery_item, state="disabled")
filemenu.bind_all("<Command-n>", lambda event: cmd_new_grocery_item)
filemenu.bind_all("<Shift-Command-n>", lambda event: cmd_new_grocery_item)
filemenu.bind_all("<Command-BackSpace>", lambda event: cmd_delete_grocery_list)
filemenu.bind_all("<Option-Command-BackSpace>",
                  lambda event: cmd_delete_grocery_item)
...
viewappearancemenu.add_cascade(menu=viewfontsmenu, label="Font Size", underline=0, state="disabled")
...
helpmenu.add_command(label="About My Grocery List...", underline=0, command=cmd_about)
helpmenu.add_command(label="View Source Code", underline=0, command=cmd_github, state="disabled")
